...
flowchart TB
    subgraph imagetools
        ...
        %% Layout row for operations -> entrypoints -> ui
            ...
            cli_entrypoint --> flat2tree
            cli_entrypoint --> ..1

            main_window --> folder_select
            main_window --> catalog
            main_window --> browser
            main_window --> action_handler
            catalog --> threaded_resizer
            action_handler --> takeout_ui
            action_handler --> flat2tree_ui

            action_handler --> operations
